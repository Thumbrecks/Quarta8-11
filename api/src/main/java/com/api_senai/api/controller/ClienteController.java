...
public class ClienteController {
    ...
    public ResponseEntity<Cliente> updateCliente (@RequestBody Cliente clienteAtualizado, @PathVariable Long id) {
        ...
        if (cliente != null){
            ...
            return new ResponseEntity<>(clienteService.updateCliente(id, clienteAtualizado), HttpStatus.OK);
        }
    ...
    public ResponseEntity<Cliente> logicaDeleteCliente(@PathVariable Long id){
